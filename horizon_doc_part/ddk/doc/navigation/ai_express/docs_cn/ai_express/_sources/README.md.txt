...
天工开物 AI 开发平台基于地平线AI芯片打造，由AI算法仓库(Model Zoo)、AI芯片工具链(AI ToolChain)及AI应用开发中间件(AI Express)三大功能模块构成，旨在通过全面降低开发者门槛、提升开发速度、保证开发质量，赋能产业智慧升级。

完整的Open Explore架构图如图所示：

![open-explore](./images/open-explore-ai-express.png "")

其中 **AI应用开发中间件**（AI Express）:包含XStream和XProto两套应用开发框架，并且内置丰富且高度可复用的算法模块、业务策略模块、应用组件，帮助合作伙伴快速搭建高性能的算法工作流。产品使用示意图如下所示：
...
**2. XProto应用开发框架**: 围绕X3芯片，提供丰富的应用开发中间件（视频通路虚拟化，数据可视化等），支持用户快速完成AI应用的开发。
